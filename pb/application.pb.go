...
type AcceptBountyRequest struct {
	...
	HunterId      int64                  `protobuf:"varint,2,opt,name=hunter_id,json=hunterId,proto3" json:"hunter_id,omitempty"`
...
func (x *AcceptBountyRequest) GetHunterId() int64 {
	if x != nil {
		return x.HunterId
	}
	return 0
...
const file_application_proto_rawDesc = "" +
	"\n" +
	"\x11application.proto\x12\x02pb\x1a\fcommon.proto\"O\n" +
	"\x13AcceptBountyRequest\x12\x1b\n" +
	"\tbounty_id\x18\x01 \x01(\x03R\bbountyId\x12\x1b\n" +
	"\thunter_id\x18\x02 \x01(\x03R\bhunterId\"O\n" +
